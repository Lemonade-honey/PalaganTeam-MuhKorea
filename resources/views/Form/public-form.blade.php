...
<body>
    {{-- 
        required relation left join, id massage
        required atribut massage_box dari tabel massage
    --}}
                        ...
                        @if ($form->massage_box != null)
                            ...
                            <article class="p-6 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                ...
                                <div class="flex items-center mt-4 space-x-4">
                                    <form action="{{ route('massage.storeReply', ['id' => $form->id_massage, 'slug' => $form->slug, 'kode' => $item['code']]) }}" method="post">
                                        @csrf
