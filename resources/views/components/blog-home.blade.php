        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                    <h2 class="text-blue-600 mb-4 text-3xl font-bold md:text-md">
                        Our Recent News
                    </h2>
        ...
        <div class="flex flex-col justify-center items-center ">
            <div class="w-1/3 shadow-lg mb-7 rounded-md px-4  md:w-full lg:w-1/2">
                <div class="mx-auto mb-10 max-w-[370px]">
                    ...
                    <div>
                        <span
                            class="bg-blue-600 mb-5 inline-block rounded py-1 px-4 text-center text-xs font-semibold leading-loose text-white">
                            Dec 22, 2023
                        </span>
                        <h3>
                            <a href="javascript:void(0)"
                                class="text-dark hover:text-blue-600 mb-4 inline-block text-xl font-semibold sm:text-2xl lg:text-xl xl:text-2xl">
