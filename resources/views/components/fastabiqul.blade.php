<main class="pt-2 pb-4 lg:pt-4 lg:pb-6 px-10">
    <aside aria-label="Related articles" class="py-2 lg:py-6 rounded-md bg-gray-50 dark:bg-gray-800">
        <div class="px-4 mx-auto max-w-screen-xl">
            <h2 class="mb-8 text-2xl font-bold text-blue-800">Fastabiqul Khairat</h2>
