...
<body>
    ...
    <form method="post" action="{{ route('activity.postCreate') }}" enctype="multipart/form-data">
        ...
        <p>tanggal</p>
        <input type="date" name="tanggal" id="" placeholder="tanggal" value="{{ old('tanggal') }}">
        <p>time start</p>
        <input type="time" name="time_start" id="" placeholder="time_start" value="{{ old('time_start') }}">
        <p>time finish</p>
        <input type="time" name="time_finish" id="" placeholder="time_end" value="{{ old('time_finish') }}">
        <p>details</p>
